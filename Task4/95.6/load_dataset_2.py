...
class Setup_whole_training_data:
    def __init__(self, x_labeled, y_labeled, x_unlabeled, y_unlabeled):
        self.x_labeled = x_labeled
        self.y_labeled = y_labeled
        self.x_unlabeled = x_unlabeled
        self.y_unlabeled = y_unlabeled

    def split_balance_data(self, splitsize):
        self.x_data = np.concatenate((self.x_labeled, self.x_unlabeled), axis = 0)
        self.y_data = np.concatenate((self.y_labeled, self.y_unlabeled))
