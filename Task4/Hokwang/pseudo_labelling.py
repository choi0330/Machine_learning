...
def main():
    ...
    pseudo_label_path = ["pseudo1.csv", "pseudo2.csv", "pseudo3.csv", "pseudo4.csv", "pseudo5.csv", "pseudo6.csv"]
    ...
    pseudo_path = [output_file + "pseudo1.csv", output_file + "pseudo2.csv", output_file + "pseudo3.csv",
                   output_file + "pseudo4.csv", output_file + "pseudo5.csv", output_file + "pseudo6.csv"]
    y2_test = most_common_selection(num_nn, pseudo_path)
    write_csv(os.path.join(output_file, "pseudo_label.csv"), y2_test)
